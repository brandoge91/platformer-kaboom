(() => {
  ...
  var require__ = __commonJS({
    "code/levels/1.json"(exports, module) {
      module.exports = {
        name: "Level One Placeholder",
        blocks: [
          {
            x: 0,
            y: 500,
...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  player.spawn();
  onCollide("movable", "wall", (a2, b2) => {
    a2.speed = 0;
  });
  onCollide("movable", "movable", (a2, b2) => {
    if (a2.speed > b2.speed)
      b2.direction = a2.direction;
    else if (a2.speed <= b2.speed)
      a2.direction = b2.direction;
    finalSpeed = a2.speed + b2.speed / (a2.mass + b2.mass);
    a2.speed = finalSpeed;
    b2.speed = finalSpeed;
  });
})();
